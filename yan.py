...
canvas = Canvas(tk, width=500, height=400, highlightthickness=0, background='Green')
...
class Ball:
    ...
    def draw(self):
        ...
        if pos[3] >= self.canvas_height:
            ...
            canvas.create_text(250, 120, text='Вы проиграли!!! ={', font=('Arial', 30), fill='Gold')
